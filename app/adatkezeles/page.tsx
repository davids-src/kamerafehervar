...
export const metadata: Metadata = {
  title: 'Adatkezelési tájékoztató — Kamera Fehérvár',
  description: 'Adatkezelési tájékoztató — Kamera Fehérvár (SIROTECH Kft.)',
  ...
  return (
    <div className="min-h-screen bg-paper">
      ...
      <main className="max-w-content mx-auto px-4 sm:px-6 py-12 pb-24 md:pb-12">
        <h1 className="text-2xl sm:text-3xl font-extrabold text-navy mb-8">Adatkezelési tájékoztató</h1>
        <div className="prose prose-sm max-w-none font-body text-ink/80 space-y-4">
          <p className="text-ink/50 italic">Ez egy placeholder oldal. A végleges adatkezelési tájékoztató szöveg külön promptban érkezik.</p>
          <h2 className="font-display font-bold text-lg text-navy">Adatkezelő</h2>
